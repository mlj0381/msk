...
//End Function
    ...
    public function get_node_path($node_id) {
        ...
        if ($row['parent_id'] == 0)
            return array('node_depth' => 1, 'node_path' => $row['node_id']);
...
//        $content_api = vmc::singleton('content_source_nodes');
//        if (method_exists($content_api, 'fatch_all')) {
//            $node_list = $content_api->fatch_all();
//        } else {
            //没定义接口调用本地数据
