...
{	
    ...
    {
        $btn = '<a href="index.php?app=b2c&ctl=admin_pages_content&act=index&position_id='.$row['position_id'].'" class="btn btn-default btn-xs"><i class="fa  fa fa-external-link"></i>查看</a>';
